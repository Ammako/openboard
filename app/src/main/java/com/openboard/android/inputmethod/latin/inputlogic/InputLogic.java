...
package com.openboard.android.inputmethod.latin.inputlogic;
...
import com.openboard.android.inputmethod.compat.SuggestionSpanUtils;
...
import com.openboard.android.inputmethod.latin.Dictionary;
import com.openboard.android.inputmethod.latin.DictionaryFacilitator;
import com.openboard.android.inputmethod.latin.LastComposedWord;
import com.openboard.android.inputmethod.latin.LatinIME;
import com.openboard.android.inputmethod.latin.NgramContext;
import com.openboard.android.inputmethod.latin.RichInputConnection;
import com.openboard.android.inputmethod.latin.Suggest;
import com.openboard.android.inputmethod.latin.Suggest.OnGetSuggestedWordsCallback;
import com.openboard.android.inputmethod.latin.SuggestedWords;
import com.openboard.android.inputmethod.latin.SuggestedWords.SuggestedWordInfo;
import com.openboard.android.inputmethod.latin.WordComposer;
...
import com.openboard.android.inputmethod.latin.common.StringUtils;
...
import com.openboard.android.inputmethod.latin.settings.SettingsValuesForSuggestion;
import com.openboard.android.inputmethod.latin.settings.SpacingAndPunctuations;
import com.openboard.android.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import com.openboard.android.inputmethod.latin.utils.AsyncResultHolder;
import com.openboard.android.inputmethod.latin.utils.InputTypeUtils;
import com.openboard.android.inputmethod.latin.utils.RecapitalizeStatus;
import com.openboard.android.inputmethod.latin.utils.StatsUtils;
import com.openboard.android.inputmethod.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link com.openboard.android.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link com.openboard.android.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link com.openboard.android.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, com.openboard.android.inputmethod.latin.SuggestedWords)}.
