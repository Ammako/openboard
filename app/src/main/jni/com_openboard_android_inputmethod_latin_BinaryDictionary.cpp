...
static const JNINativeMethod sMethods[] = {
    ...
    },
    {
        ...
        const_cast<char *>(
                "(J[Lcom/openboard/android/inputmethod/latin/utils/WordInputEventForPersonalization;I)I"),
...
int register_BinaryDictionary(JNIEnv *env) {
    const char *const kClassPathName = "com/openboard/android/inputmethod/latin/BinaryDictionary";
